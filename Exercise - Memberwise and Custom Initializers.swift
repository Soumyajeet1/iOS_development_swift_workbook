...
{
    var title = "Hello Man"
    var author = "Hutkarsh Majmani"
    var pages = 169
    var price = 63.98
}
var favoriteBook = Book()
print(favoriteBook)
favoriteBook = Book(title: "Kya Bolta", author: "Mia Bhai", pages: 669, price: 98.87)
print(favoriteBook)
...
var instanceOne = Laptop(yearPurchased: 2002)
var instanceTwo = Laptop(screenSize:15, repairCount:3, yearPurchased: 2022)
print(instanceOne)
print(instanceTwo)
